...
import ejercicio6.Iterator_Iterable;
 ...
 *            listas est�n desordenadas y la lista resultante debe quedar
 *            ordenada. b) Las listas est�n ordenadas y la lista resultante debe
 *            mantenerse ordenada.
 */
...
public class MySimpleLinkedList<T> {
	...
	public void insertInOrden(T value) {
		if (this.isEmpty()) {//Si es vac�o inserto comun
			insertFront(value);
		} else {
